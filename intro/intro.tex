...
The problem has been formulated based on an initial meeting with Danni Jensen, who stated that the process should \myquote{identificeres, automatiseres og effektiviseres}.(Appendix \completeref{app:danni_initiation})\todo{Paraphrased! Change quote?}
