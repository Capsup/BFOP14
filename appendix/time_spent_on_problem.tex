...
\end{itemize}
These numbers show how many computers have been made ready by year. \todo{"- i forbindelse med ansættelser"}
...
And even when edge cases happen, as the process doesn't change, \emph{the time spent doesn't increase, only the amount of frustration in the IT department.}\todo{Ændrer processen sig ikke?}
