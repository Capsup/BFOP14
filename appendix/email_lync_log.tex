...
\todo{Includegraphics appendix/danni \_communication\_1}
...
\todo{includefigure appendix/peter\_communication\_1}


\subsection{Communication with Lisbeth}

\subsubsection{Time Estimation}
\todo{includefigure appendix/lisbeth\_communication\_1} 

\subsubsection{Data on Hires and Resignations}
\todo{includefigure appendix/lisbeth\_communication\_2}


\subsection{Communication with Hanne}

\subsubsection{Time Estimation}
\todo{includefigure appendix/hanne\_communication\_1}


\subsection{Communication with Jytte}

\subsubsection{Time Estimation}
\todo{includefigure appendix/jytte\_communication\_1}


\subsection{Communication with others}

\subsubsection{Question to another student help about structure in IT}
\todo{includefigure appendix/other\_communication\_1}