...
Firstly, a lot of time is spent communicating information back and forth between Accounting and Recruitment. (Source: appendix \quoteref{app:lisbeth}{lisbeth_vende_tilbage})
Each department maintain their own data, in individual Excel spreadsheets, about the new employees. (Source: appendix \quoteref{app:lisbeth}{lisbeth_ark})
This should be optimized with the new HR-system.
Similarly time is spent communicating the information to the IT-department. (Source: appendix \quoteref{app:lisbeth}{lisbeth_IT})
...
(Source: appendix \quoteref{app:peter}{peter_frustration1}, appendix \quoteref{app:peter}{peter_frustration2}, appendix \quoteref{app:peter}{peter_frustration3} and appendix \quoteref{app:peter}{peter_datamangel})

Thirdly, time is spent on routine tasks, such as defining new initials, which could be automated if the data was kept in a standard format. (Source: appendix \quoteref{app:peter}{peter_initialer})

Part of the problem with incomplete data is that the initiators are not all aware of which information the IT-department needs in order to set the new employee up correctly. (Source: appendix \quoteref{app:jytte}{jytte_stamdata})
